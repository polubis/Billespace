...
const Template: Story<SelectionDialogProps> = (args) => (
...
Default.args = {
  children: [
    <SelectionDialogItem key={0} motive="gray">
      <span>A</span>
    ...
    <SelectionDialogItem key={2} motive="green">
      <span>Third option</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={3} motive="red">
      <span>Fourth option</span>
    </SelectionDialogItem>,
    <SelectionDialogItem key={4} motive="gray" dotted>
      <span>A</span>
      <span>First option is to big to fit screen</span>
    </SelectionDialogItem>,
  ],
